...
#[serde(rename_all = "camelCase")]
#[ts(export)]
pub struct CalculationMatrixTuple {
...
#[serde(rename_all = "camelCase")]
#[ts(export)]
pub struct CalculationMatrixOutput {
...
#[serde(rename_all = "camelCase")]
#[ts(export)]
pub struct ComputedCalculationMatrix {
    pub row_tuples: Vec<CalculationMatrixTuple>,
    pub column_tuples: Vec<CalculationMatrixTuple>,
    pub cells: Vec<Vec<ComputedCell>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    #[ts(optional)]
