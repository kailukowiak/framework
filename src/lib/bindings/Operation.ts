...
import type { CalculationMatrixFormulaInput } from "./CalculationMatrixFormulaInput";
...
export type Operation =
  ...
  | { "type": "addCalculationMatrix"; name: string; x: number; y: number }
  | {
    "type": "setCalculationMatrix";
    objectId: string;
    rows: Array<CalculationMatrixFormulaInput>;
    columns: Array<CalculationMatrixFormulaInput>;
    body: string;
  }
  | {
    "type": "setBlockSource";
